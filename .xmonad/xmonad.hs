...
myFont :: String
myFont = "xft:NotoSansMono Nerd Font:bold:size=9"
...
myStartupHook = do
          ...
          spawnOnce "/usr/bin/emacs --with-x-toolkit=lucid --daemon &"
...
myApplications = [("Emacs", "emacs", "Much more than a text editor")
                 ...
                 , ("Qutebrowser", "qutebrowser", "Minimal Browser")
                 , ("Rstudio", "rstudio-bin", "IDE for working with R")
                 ...
                 , ("LibreOffice Calc", "localc", "A fully featured spreadsheet processor")
                 , ("Steam", "steam", "Proprietary gaming platform")
                 ]

myBookmarks :: [(String, String, String)]
myBookmarks = [ ("Twitter", myBrowser ++ "https://www.twitter.com", "Twitta, jovem")
              , ("YouTube", myBrowser ++ "https://www.youtube.com", "YouTuba, jovem")
              , ("Logeion", myBrowser ++ "https://logeion.uchicago.edu/", "Digital Greek Dictionaries")
              , ("TLG", myBrowser ++ "https://stephanus.tlg.uci.edu", "Thesaurus Linguae Greaeca")
              , ("Μορφώ", myBrowser ++ "https://logeion.uchicago.edu/morpho/", "Greek Morpho analysis")
              , ("Veda Web", myBrowser ++ "https://vedaweb.uni-koeln.de/rigveda/", "Veda Web: Rgveda")
              , ("Graßman Wörterbuch",  myBrowser ++ "https://www.sanskrit-lexicon.uni-koeln.de/scans/GRAScan/2020/web/webtc/indexcaller.php", "Grassman Wörterbuch zum Rig Veda")
              , ("Monier-Williams Dictionary", myBrowser ++ "https://www.sanskrit-lexicon.uni-koeln.de/scans/MWScan/2020/web/webtc/indexcaller.php", "Monier-Williams Sanskrit-English Dictionary")
              , ("Petersburger Wörterbuch", myBrowser ++ "https://www.sanskrit-lexicon.uni-koeln.de/scans/PWGScan/2020/web/webtc/indexcaller.php", "Böhtlingk and Roth Grosses Petersburger Wörterbuch")
              , ("Köln Sanskrit Dictionaries", myBrowser ++ "https://www.sanskrit-lexicon.uni-koeln.de/", "Sanskrit Dictionaries digitalized by the Universität zu Köln")
              , ("GitHub", myBrowser ++ "https://www.github.com", "GitHub, ué")
              , ("The Guardian", myBrowser ++ "https://www.theguardian.com", "The Guardian, aquele jornal estranho")
              , ("Folha de São Paulo", myBrowser ++ "folha.uol.com.br/", "Folha, pra sofrer.")
...
myConfigs = [ ("bashrc", myEditor ++ "/home/silenux/.bashrc", "the bourne again shell")
            , ("doom emacs config.org", myEditor ++ "/home/silenux/.doom.d/config.el", "doom emacs config")
            , ("doom emacs init.el", myEditor ++ "/home/silenux/.doom.d/init.el", "doom emacs init")
            , ("xmonad.hs", myEditor ++ "/home/silenux/.xmonad/xmonad.hs", "xmonad config")
            , ("xmobar", myEditor ++ "/home/silenux/.config/xmobar/xmobarrc0", "xmobar config")
            , ("zshrc", myEditor ++ "/home/silenux/.zshrc", "config for the z shell")
            , ("vimrc", myEditor ++ "/home/silenux/.config/nvim/init.vim", "config for nvim")
            ]


myMainBooks :: [(String, String, String)]
myMainBooks = [ ("Cambridge Greek Grammar", myPDFER ++ "/home/silenux/Documentos/Línguas/Indo-Europeias/Grego/Gramáticas/boas2019.pdf", "The Cambrige Grammar of Classical Greek")
              , ("Rix 1992", myPDFER ++ "/home/silenux/Documentos/Línguas/Indo-Europeias/Grego/Gramáticas/rix1992.pdf", "Rix, H. Historische Grammatik des Griechischen")
              , ("Chantraine 1968",  myPDFER ++ "/home/silenux/Documentos/Línguas/Indo-Europeias/Dicionários/chantraine1968.pdf", "Chantraine, P. Dictionnaire Étymologique de la Langue Grecque")
              , ("Frisk 1960",  myPDFER ++ "/home/silenux/Documentos/Línguas/Indo-Europeias/Dicionários/frisk1960.pdf", "Frisk, H. Griechisches Etymologisches Wörterbuch")
              , ("Beekes 2010",  myPDFER ++ "/home/silenux/Documentos/Línguas/Indo-Europeias/Dicionários/leiden/beekes2010.pdf", "Beekes, R. Etymological Dictionary of Greek")
              , ("Whitney Sanskrit Grammar", myPDFER ++ "/home/silenux/Documentos/Línguas/Indo-Europeias/Védico/whitney1896.pdf", "Whitney, W. A Sanskrit Grammar")
...
myMainBooksGrid :: [(String, String)]
myMainBooksGrid = [ (a,b) | (a,b,c) <- xs]
  where xs = myMainBooks
...
treeselectAction a = TS.treeselectAction a
   ...
   , Node (TS.TSNode "livros importantes" "livros que eu uso com frequência" (return ()))
     [Node (TS.TSNode (TE.fst3 $ myMainBooks !! n)
                      (TE.thd3 $ myMainBooks !! n)
                      (spawn $ TE.snd3 $ myMainBooks !! n)
           ) [] | n <- [0..(length myMainBooks - 1)]
     ]
   ]
...
myWorkspaces = clickable . (map xmobarEscape)
               -- $ ["1", "2", "3", "4", "5", "6", "7", "8", "9"]
               $ ["dev", "www", "sys", "doc", "etc", "chat", "coisas", "vid", "mus"]
  where
...
myManageHook = composeAll
     ...
     , className =? "rstudio" --> doShift ( myWorkspaces !! 4 )
     , className =? "mpv"     --> doShift ( myWorkspaces !! 7 )
     , className =? "mocp"     --> doShift ( myWorkspaces !! 8 )
     , title =? "mocp"     --> doShift ( myWorkspaces !! 8 )
     , className =? "Spotify" --> doShift ( myWorkspaces !! 8 )
     , title =? "Spotify" --> doShift ( myWorkspaces !! 8 )
...
tabs     = renamed [Replace "tabs"]
  ...
  where
    myTabConfig = def { fontName            = "xft:NotoSansMono Nerd Font:regular:pixelsize=11"
                      , activeColor         = "#292d3e"
...
myKeys =
    ...
    -- Grid Select (CTRL-g followed by a key)
        ...
        , ("C-g b", spawnSelected' myMainBooksGrid)           -- grid select main books
        , ("C-g t", goToSelected $ mygridConfig myColorizer)  -- goto selected window
        , ("C-g s", bringSelected $ mygridConfig myColorizer) -- bring selected window

    -- Tree Select/
        -- tree select actions menu
        , ("C-S-t a", treeselectAction tsDefaultConfig)
    ...
    --- My Applications (Super+Alt+Key) or (Super-(Shift)-FX)
        , ("M-M1-m", spawn (myTerminal ++ " -e mocp"))
        , ("M-M1-r", spawn "rstudio-bin")
        , ("M-M1-l", spawn "localc")
        , ("M-M1-s", spawn "steam")
        , ("M-M1-y", spawn (myTerminal ++ " -e youtube-viewer"))
        , ("M-<F2>", spawn "firefox")
        , ("M-S-<F2>", spawn "qutebrowser")
        , ("M-<F3>", spawn (myTerminal ++ " -e ranger"))
        , ("M-S-<F3>", spawn "pcmanfm")
        , ("M-<F4>", spawn "firefox --private-window")
        , ("M-<F6>", spawn "firefox https://web.whatsapp.com/")
        , ("M-<F9>", spawn "spotify")
